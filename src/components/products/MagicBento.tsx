...
const DEFAULT_GLOW_COLOR = '168, 85, 247'; // Vernox purple
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
          ...
          const cardContent = (
            <>
              <div className="magic-bento-card__header flex items-center mb-8">
                <div className="magic-bento-card__icon mr-3 text-purple-600">
                  {card.icon}
                </div>
                {card.label && <div className="magic-bento-card__label font-bold text-xs uppercase tracking-wider text-purple-600 bg-purple-50 px-2 py-1 rounded-md border border-purple-200">{card.label}</div>}
              </div>
              <div className="magic-bento-card__content">
                <h3 className="magic-bento-card__title text-xl font-bold mb-2 text-slate-800">{card.title}</h3>
                <p className="magic-bento-card__description text-sm text-slate-500 leading-relaxed">{card.description}</p>
              </div>
            </>
          );
